...
class SendOnTheDayReminder extends EstJob implements ShouldQueue
{
    ...
    public function __construct(\App\User $User, $event)
    {
        ...
        $this->data['event_time']               = \App\Classes\Tools::timeformat($event['eventTime']);
