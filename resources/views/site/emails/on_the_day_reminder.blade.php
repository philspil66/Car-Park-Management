...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>On the day reminder</title>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="color:#465a64; border-collapse: collapse;">
            ...
            <tr>
                <td colspan="2" style="padding:20px 10px;">
                    ...
                    <p>It appears we still do not have your car registration number for <strong>today's</strong> event <strong>{{ $event }}</strong> at <strong>{{ $event_time }}</strong>. You must provide the registration number before you can print an e-Ticket for the parking.
